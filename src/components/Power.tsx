...
const Power = () => {
  return (
    <div className="flex overflow-clip h-[80vh] bg-[url(./src/assets/images/line_5.png)] bg-no-repeat justify-between mt-24 max-sm:mx-2 ml-12 ">
      ...
      <img src={images.gradient} 
      className="absolute mt-[32vh] hidden xl:flex w-[95vw] max-lg:hidden" 
      alt="gradient" />
    </div>
  );
};
