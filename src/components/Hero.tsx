...
const Hero = () => {
  return (
    <>
    <div className="flex justify-between mt-24 max-sm:mx-2 ml-12 ">
      <div className="  max-sm:w-full pl-5">
        ...
        <p className="text-white/50  w-[70%] max-sm:w-full  my-3">{HeroContent.content.desc}</p>
      ...
      <div className="max-sm:hidden   bg-[url(./src/assets/images/circle.png)] w-[70%] bg-no-repeat pb-12 xl:pl-[30vw]  ">
       <img src={images.star} alt="star" />
        <img className="max-md:scale-90 -ml-14  mt-[5vh] " src={images.float_1} alt="feature1" />
        <img className="max-md:scale-90 -ml-[30vw] " src={images.float_2} alt="feature1" />
        <img src={images.star} className="scale-75 -ml-12" alt="star" />
        <img className="max-md:scale-90 -mt-[5vh] " src={images.float_3} alt="feature1" />
      </div>
    </div>
      <img src={images.gradient} alt="gradient" 
      ...
      <div className="partner flex  flex-wrap justify-between mx-12">
        {HeroContent.partner.map((item, index) => {
          return (
            <img key={index} className="mb-5" src={item.img} alt={"partner"} />
          )
        })}
      </div>
    </>
